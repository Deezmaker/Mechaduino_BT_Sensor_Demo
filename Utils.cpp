...
void serial1Check() {        //Monitors serial for commands.  Must be called in routinely in loop for serial interface to work.
  ...
  if (Serial1.available()) {
    ...
    switch (inChar) {
      ...
      case 'd':             //dir
        ...
        Serial1.println("Changed Direction");
        break;
      ...
      case 'r':             //new setpoint
        Serial1.println("Move to Target:");
      ...
      case 'R':             //new rotation postion
        Serial1.println("Moving to Rotations:");
        while (Serial1.available() == 0)  {}
        r = Serial1.parseFloat() * 360;
        Serial1.println(r / 360);
        break;
...
void print_angle1()                ///////////////////////////////////       PRINT_ANGLE   /////////////////////////////////
{
  ...
  anglefloat = encoderReading * 0.02197265625 / avg;     //    360/16384 = 0.021972....
  Serial1.print("stepNumber: ");
  Serial1.print(stepNumber, DEC);
  Serial1.print(" , ");
  //  SerialUSB.print(stepNumber * aps, DEC);
  //  SerialUSB.print(" , ");
  Serial1.print("Angle: ");
  Serial1.println(anglefloat, 2);
}
...
void serial1Menu() {
  Serial1.println("----- Mechaduino 0.X -----");
  Serial1.print("Firmware: ");
  Serial1.println(firmware_version);
  Serial1.print("Identifier: ");
  Serial1.println(identifier);
  Serial1.println("");
  Serial1.println(" s  -  step");
  Serial1.println(" d  -  dir");
  Serial1.println(" x  -  position mode");
  Serial1.println(" v  -  velocity mode");
  Serial1.println(" t  -  torque mode");
  Serial1.println(" y  -  enable control loop");
  Serial1.println(" n  -  disable control loop");
  Serial1.println(" r  -  enter new setpoint");
  Serial1.println(" m  -  print main menu");
  SerialUSB.println("--------");
}
void sineGen() {
  int temp;
